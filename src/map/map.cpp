...
// Global flag to skip monster imports during reload
static bool g_reload_skip_monsters = false;
...
{
    g_reload_skip_monsters = true;  // Enable monster skip flag
    map_reloadnpc(clear);           // Call normal reload function
