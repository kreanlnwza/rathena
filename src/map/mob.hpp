...
const t_tick MVP_WARP_COOLDOWN = 60000; // 1 minute cooldown
const int16 MVP_WARP_RANGE = 5; // Detection range for warp NPCs
...
struct mob_data : public block_list {
    ...
    t_tick mvp_warp_last_time; // Last time MVP teleported from warp NPC
