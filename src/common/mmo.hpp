...
// Guild-based inventory slots calculation
// Each guild level provides additional inventory slots
#define GUILD_INVENTORY_SLOTS_PER_LEVEL 5 // Additional slots per guild level
#define CALC_GUILD_INVENTORY_SLOTS(guild_lv) MIN( ( INVENTORY_BASE_SIZE + ( (guild_lv) * GUILD_INVENTORY_SLOTS_PER_LEVEL ) ), MAX_INVENTORY )
